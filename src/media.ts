...
/**
 * Auto-discover screenshots under public/projects/<id>/.
...
const cloud89Modules = import.meta.glob(
  "../public/projects/cloud89/*.{png,jpg,jpeg,webp,gif}",
  { eager: true, query: "?url", import: "default" },
);
const masModules = import.meta.glob(
  "../public/projects/mas/*.{png,jpg,jpeg,webp,gif}",
  { eager: true, query: "?url", import: "default" },
);
const llmModules = import.meta.glob(
  "../public/projects/llm/*.{png,jpg,jpeg,webp,gif}",
  { eager: true, query: "?url", import: "default" },
);
const attendanceModules = import.meta.glob(
  "../public/projects/attendance/*.{png,jpg,jpeg,webp,gif}",
  { eager: true, query: "?url", import: "default" },
);
const dramaModules = import.meta.glob(
  "../public/projects/drama/*.{png,jpg,jpeg,webp,gif}",
  { eager: true, query: "?url", import: "default" },
);
...
export const projectMedia: Record<string, ProjectImage[]> = {
  cloud89: projectImagesFromGlob(
    ...
    "船舶管理云平台",
    {
      "image.png": "船舶运行监控中心 · 告警与航行态势",
      "image1.png": "实时视频墙 · 多通道监控",
      "image2.png": "航规区域 · 地图绘制与规则配置",
      "image3.png": "组织权限 · 企业与角色管理",
      "image4.png": "单船监控中心 · 实时视频与告警概览",
    },
  ),
  mas: projectImagesFromGlob(masModules, "projects/mas", "MAS 船端告警", {
    "image1.png": "船舶数据大屏 · 监控总览",
    "image2.png": "告警记录列表 · 开发界面",
    "image3.png": "告警任务配置 · 开发界面",
    "image4.png": "GPS 轨迹与航速着色 · 调试界面",
    "image5.png": "告警规则与联动处理 · 开发界面",
    "image6.png": "船岸协同与处置闭环 · 开发界面",
  }),
  ...
  drama: projectImagesFromGlob(
    ...
    "Yihen Drama",
    {
      "workspace.png": "创作工作台与项目管理",
      "assets.png": "角色与场景资产管理",
      "storyboards.png": "分镜编排与资产关联",
      "generation.png": "首帧预览与视频生成工作区",
    },
    [
      "workspace.png",
      "assets.png",
